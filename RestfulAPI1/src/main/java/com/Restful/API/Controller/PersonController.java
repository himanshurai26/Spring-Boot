...
public class PersonController {
	...
	public ResponseEntity<Void> deleteById(@PathVariable("id") int personId) {
	...
	public ResponseEntity<Person> updateById(@RequestBody Person person, @PathVariable("id") int personId) {
		try {
